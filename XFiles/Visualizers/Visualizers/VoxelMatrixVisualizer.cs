...
namespace XFiles.Visualizers.Visualizers
{
    public sealed class VoxelMatrixVisualizer : IAudioVisualizer
    {
        ...
        public void Update(AudioData data, TimeSpan elapsed)
        {
            ...
            _cameraAngle += (0.08f + _smoothAvg * 0.15f) * (float)elapsed.TotalSeconds;
        ...
        {
            float glowAlpha = (byte)Math.Min(255, (int)(15 + _smoothBeat * 30));
            float hue = (_time * 0.03f) % 1.0f;
            Color c = HslToRgb(hue, 0.6f, 0.3f);
            var geo = CanvasGeometry.CreateEllipse(ds, _width * 0.5f, _height * 0.3f, _width * 0.6f, _height * 0.3f);
            ...
            float w, float h, float blockH, Color color, float fog)
        {
            ...
            {
                new System.Numerics.Vector2(sx, sy - bh),
                new System.Numerics.Vector2(sx + hw, sy - bh + hh),
                new System.Numerics.Vector2(sx, sy - bh + h),
                new System.Numerics.Vector2(sx - hw, sy - bh + hh)
            });
