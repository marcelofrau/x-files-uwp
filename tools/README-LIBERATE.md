...
```pwsh
# Windows
pwsh ./liberate-loopback.ps1 -Ip 10.0.0.98 -User keita
```

```bash
# Linux / macOS
./liberate-loopback.sh -ip 10.0.0.98 -user keita
```
...
./liberate-loopback.sh -ip 10.0.0.98 -user keita -app RetroArch
...
curl -k -u keita:<portal-password> "https://<XBOX-IP>:11443/ext/smb/developerfolder"
