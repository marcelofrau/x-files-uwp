...
<div class="hero">
  ...
  <div class="pills">
    ...
    <span class="pill">Text editor</span>
  </div>
</div>
...
- [Deploy to your Xbox](DEPLOY-XBOX.html) — Developer Mode, Device Portal, sideload.
...
- [Download releases](https://github.com/marcelofrau/x-files-uwp/releases) — grab the latest package.
