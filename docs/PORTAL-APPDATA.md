...
| What | Where | Example |
|---|---|---|
| **Console IP** | Xbox Dev Home (or Settings → Network → Advanced) | `10.0.0.98` |
| **Portal username** | Dev Home → **Device Portal** | `keita` |
| **Portal password** | Dev Home → **Device Portal** | `boris12345` |
